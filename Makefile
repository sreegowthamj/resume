...
$(RESUME_PDF_PANDOC): $(BUILD_DIR) head.tex $(RESUME_SRC)
	@pandoc --pdf-engine=xelatex --variable subparagraph -V fontsize:11pt -H head.tex $(RESUME_SRC) -o $(RESUME_PDF_PANDOC) #--variable classoption=twocolumn
...
pandoc_resume_simple: $(BUILD_DIR) $(RESUME_SRC)
